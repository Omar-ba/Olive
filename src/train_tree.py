...
def train_tree(data_dir="data/tree_classification", epochs=15, batch_size=32, learning_rate=1e-4):
    """
    Entraîne le modèle de classification olive/non-olive
    """
    print("🌳 Initialisation de l'entraînement classification olive...")
    ...
    for epoch in range(epochs):
        ...
        if val_accuracy > best_accuracy:
            ...
            torch.save(model.state_dict(), "models/tree_model.pth")
